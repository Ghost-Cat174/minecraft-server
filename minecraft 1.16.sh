...
cd $path && wget https://github.com/KittyCat951/minecraft-server/releases/download/server.propeties/server-1.16.properties -O server.properties
...
echo --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
echo Pro-Tip! when typeing a file or folder name E.G: $path or $path/server.properties press the TAB key to compleate the name of the folder or file!
